...
namespace Tabungan_Ceritanya_V2
{
    public partial class MainForm : Form
    {
        ...
        private void AddTransaction(string type)
        {
            ...
            {
                MessageBox.Show("Please fill the blank fields.", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            if (int.TryParse(customTextBox1.Texts, out int jumlahInt))
            {
                ...
                if (type == "EXPENSE")
                {
                    ...
                    {
                        MessageBox.Show("Alasan harus diisi untuk pengeluaran.", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        return;
                    }
                }
                ...
                try
                {
                    ...
                    MessageBox.Show($"{(type == "INCOME" ? "Pemasukan" : "Pengeluaran")} berhasil dicatat!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                MessageBox.Show("Masukkan angka bulat yang valid (tanpa koma).");
            }
        }
        ...
        private string PromptReason()
        {
            using (Form prompt = new Form())
            {
                ...
                prompt.Text = "Masukkan Alasan Pengeluaran";
                prompt.StartPosition = FormStartPosition.CenterScreen;

                Label textLabel = new Label() { Left = 20, Top = 20, Text = "Alasan:" };
